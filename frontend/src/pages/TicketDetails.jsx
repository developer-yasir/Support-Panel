            ...
            >
                ...
                <div className="flex">
                    ...
                    <div className="flex-1 p-6">
                        ...
                        {/* Reply Editor */}
                        {activeTab && (
                            <div className={`bg-white border rounded-lg shadow-sm overflow-hidden relative ${activeTab === 'note' ? 'border-yellow-200 bg-yellow-50/30' : 'border-gray-200'}`}>
                                <div className="p-6 pb-24">
                                    ...
                                    {/* Sprint 1 Feature 2: Character Count */}
                                    ...
                                    {/* Sprint 1 Feature 1: Sticky Submit Button */}
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                >
                                                    ...
                                                    {isSubmitting ? 'Submitting...' : (activeTab === 'note' ? 'Add Note' : 'Send Reply')}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
